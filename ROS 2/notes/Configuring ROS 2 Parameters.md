...
[[Parameter|Parameters]] allow the behavior of a ROS 2 node to be configured without modifying its source code. They can be set before or during runtime, depending on the implementation of the node.
